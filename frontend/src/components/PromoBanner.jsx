          ...
          <div className="relative grid lg:grid-cols-3 gap-0 items-stretch min-h-[220px]">
            ...
            <div className="lg:col-span-2 flex flex-col justify-center px-8 py-10 gap-4">
              <div className="flex items-center gap-2">
                ...
                <div className="bg-white/20 rounded-full px-3 py-1 text-white text-sm">Ưu đãi có hạn</div>
              </div>
              ...
              <div>
                ...
                <p className="text-white/90 text-xl font-semibold mt-1">
                  Chi phí thấp nhất · 100% việc làm
                </p>
              </div>

              <p className="text-white/80 text-sm max-w-lg">
                Cơ hội vàng để bắt đầu hành trình du học tại Úc với học bổng lên đến 20% học phí. Visa dễ dàng, định cư lâu dài, chất lượng cuộc sống hàng đầu thế giới.
              </p>
              ...
              <div className="flex flex-wrap gap-2 mt-1">
                {['Học bổng 20%', 'Miễn phí tư vấn', 'Hỗ trợ visa', 'Bảo lãnh việc làm'].map(b => (
            ...
            <div className="relative hidden lg:block">
              <img
                ...
                alt="Du học sinh tại Úc"
                className="absolute inset-0 w-full h-full object-cover object-top"
                loading="lazy"
              />
              {/* Sydney Opera House overlay badge */}
              <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-xl px-3 py-2 shadow-lg">
                <div className="flex items-center gap-2">
                  <span className="text-2xl">🇦🇺</span>
                  <div>
                    <div className="text-xs font-bold text-gray-800">Sydney, Australia</div>
                    <div className="text-xs text-gray-500">Opera House</div>
                  </div>
                </div>
              </div>
            </div>
