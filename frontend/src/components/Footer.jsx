    ...
    <footer className="bg-gray-900 text-gray-300">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-5">
              ...
              <div>
                <div className="font-black text-orange-400 text-lg leading-none tracking-tight">ABS</div>
                <div className="text-gray-500 text-[10px] leading-none font-medium tracking-wider">DU HỌC</div>
              </div>
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed mb-5">
              ABS tự hào là đơn vị có hơn 8 năm kinh nghiệm hoạt động trong lĩnh vực tư vấn du học và xuất khẩu lao động, phục vụ hàng nghìn gia đình Việt Nam.
            </p>
            {/* Social links */}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-400">123 Nguyễn Văn Linh, Quận Hải Châu, Đà Nẵng</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:19001899" className="text-gray-400 hover:text-orange-400 transition-colors">1900 1899</a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@absduhoc.edu.vn" className="text-gray-400 hover:text-orange-400 transition-colors">info@absduhoc.edu.vn</a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 text-orange-400 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd"/></svg>
                <span className="text-gray-400">Thứ 2 – Thứ 7: 8:00 – 17:30</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="bg-gray-800 rounded-xl p-4 border border-gray-700">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm font-semibold text-white">Fanpage Facebook</span>
              </div>
              <p className="text-xs text-gray-500 mb-3">Theo dõi fanpage để cập nhật thông tin du học mới nhất</p>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-500">© 2025 ABS Du Học. Tất cả quyền được bảo lưu.</p>
